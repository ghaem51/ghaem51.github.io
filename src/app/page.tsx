          ...
          {RESUME_DATA.work.map((work) => {
            return (
              <Card key={work.company}>
                <CardHeader>
                  <div className="flex items-center justify-between gap-x-3 text-base">
                    <div>
                    {work.logo && (
                        <Image
                          priority
                ...
                {/* <CardContent className="mt-2 text-xs">
                  ...
                  {work.projects.map((project) => (
                    <p key={project.name}>
                      <a className="inline-flex items-center justify-center gap-x-1 font-semibold leading-none hover:underline" target="_blank" href={project.link}>
                          {project.name+"-> "}
                      </a>
                      {project.description}
                    </p>
          ...
          {RESUME_DATA.achievements.map((achievement) => {
            return (
              ...
              <CardHeader>
                <div className="flex items-center justify-between gap-x-2 text-base">
                  <h3 className="font-semibold leading-none">
                    <a className="hover:underline" target="_blank" href={achievement.link}>
                      {achievement.name}
                    </a>
                  </h3>
                </div>
              </CardHeader>
              <CardContent className="mt-2">{achievement.description}</CardContent>
            </Card>)
            //   <ProjectCard
